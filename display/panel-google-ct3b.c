...
static const struct exynos_binned_lp ct3b_binned_lp[] = {
	...
	/* rising = 0, falling = 32 */
	BINNED_LP_MODE_TIMING("low", 332, ct3b_lp_low_cmds, 0, 32),
	BINNED_LP_MODE_TIMING("high", 3574, ct3b_lp_high_cmds, 0, 32),
};
...
static const struct exynos_dsi_cmd ct3b_init_cmds[] = {
	...
	EXYNOS_DSI_CMD_SEQ(0x51, 0x0E, 0x9B),
	EXYNOS_DSI_CMD_SEQ(0x6F, 0x04),
	EXYNOS_DSI_CMD_SEQ(0x51, 0x0F, 0xFE),
