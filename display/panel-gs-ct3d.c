...
static const struct gs_dsi_cmd ct3d_init_cmds[] = {
	...
	GS_DSI_REV_CMD(PANEL_REV_LT(PANEL_REV_EVT1_1), 0xB5, 0x2D, 0x2D, 0x2D,
				0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x2D, 0x29,
				0x29, 0x20, 0x20, 0x17, 0x17, 0x11, 0x11, 0x11, 0x11, 0x07),
	GS_DSI_REV_CMD(PANEL_REV_EVT1_1, 0xB5, 0x2A, 0x2A, 0x2A,
				0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x2A, 0x25,
