...
static const struct gs_dsi_cmd ct3b_init_cmds[] = {
	...
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xB5, 0x7F, 0x00, 0x5C, 0x67),
	GS_DSI_CMD(0x6F, 0x11),
	GS_DSI_REV_CMD(PANEL_REV_LT(PANEL_REV_EVT1_1), 0xB5, 0x59, 0x59, 0x59,
				0x59, 0x59),
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xB5, 0x5C, 0x5C, 0x5C,
				0x5C, 0x5C),
	...
	GS_DSI_REV_CMD(PANEL_REV_GE(PANEL_REV_EVT1_1), 0xB5, 0x29, 0x29, 0x29,
